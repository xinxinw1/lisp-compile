...
(function (win, udf){
  ...
  function cvar2(a){
    ...
    var r = cmp(cadr(a), "set");
    if (r == "")return "var " + cmp(car(a), "setab") + cvar3(cddr(a));
    return "var " + cmp(car(a), "setab") + " = " + r + cvar3(cddr(a));
  }
  ...
  function cvar3(a){
    ...
    var r = cmp(cadr(a), "set");
    if (r == "")return ", " + cmp(car(a), "setab") + cvar3(cddr(a));
    return ", " + cmp(car(a), "setab") + " = " + r + cvar3(cddr(a));
  }
  ...
  */
  ...
  function cifln2(a){
    ...
    var s = ifpt + "?" + yes + ":";
    if (nilp(cddr(a)))return chkrt(s + "undefined", "ifln");
    return chkrt(s + celifln(cddr(a)), "ifln");
  }
  
  function celifln(a){
    if (nilp(cdr(a))){
      var no = cmp(car(a), "iflnno");
  ...
  function cmcx(a){
    if (lisp(a)){
      if (macp(car(a)))return apl(macs[car(a)], cdr(a));
      return map(cmcx, a);
    }
    return a;
  }
